...
// See README "Project Structure". Part of the Z.AI bridge core (package qbridge).
...
func resolveFeaturesWithState(caps map[string]interface{}, state *ModelFeatureState) map[string]interface{} {
    ...
    // It is a per-request parameter validated against model capabilities in sendUpstream.
