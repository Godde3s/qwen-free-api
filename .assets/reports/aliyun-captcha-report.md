...
**Note:** `o.KEY_SECRET` points to `var Ee.KEY_SECRET` which is `"REDACTED"`.
...
- `tr(35)` returns `true`
- `tr(9, 'FqJB6iRNVYdEGpwb', '7JLsB18MnA7GX3d6LxErT1sGT68xcVuOAoxz0b7vVzY=')` returns `'REDACTED-ALIYUN-ID'` (AccessKeyId)
- `tr(9, 'FqJB6iRNVYdEGpwb', 'n9jH0yACW8YrgOBcM0v7u45+/bfozcSz8ZpvzGBXg3E=')` returns `'REDACTED'` (Secret)
